...
class AuthController:
    ...
    def login(self):
        ...
        while True:
            ...
            try:
                # Validasi username dan password untuk user
                ...
                if not user.empty:
                    ...
                    if not user.empty:
                        ...
                        continue
                # Validasi username dan password untuk validator
                ...
                if not validator.empty:
                    validator = validator[validator["password"] == password]
                    if not validator.empty:
                        ...
                        print("Invalid password. Please try again.")
                        continue
                # Validasi username dan password untuk admin
